...
def main_menu():
    """
    Function to allow user select menu options and navigation
    """
    user_selection = input("Enter 'YES' to start a game. "
                           "Enter S for Scores, H for Help or "
    ...
    if user_selection .upper() == 'YES' or user_selection .upper() == 'Y':
        ...
        print("++++ || Upside down, diagnolly, hoirzontally || ++++")
        print("++++ || Let's kick that brain into action! || ++++")
        welcome_screen()
